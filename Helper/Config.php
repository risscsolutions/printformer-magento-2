...
class Config extends AbstractHelper
{
    ...
    {
        return $this->getConfigValue(self::XML_PATH_CONFIG_ENABLED, true,
            $storeId, $websiteId);
    }
    ...
    {
        return intval($this->getConfigValue(self::XML_PATH_CONFIG_DISPLAY_MODE,
            false, $storeId, $websiteId));
    }
    ...
    public function isFullscreenButtonEnabled(
        ...
        return $this->isFrameEnabled()
            && $this->getConfigValue(self::XML_PATH_CONFIG_FRAME_FULLSCREEN,
                true, $storeId, $websiteId);
    }
    ...
    {
        return $this->getConfigValue(self::XML_PATH_CONFIG_HOST, false,
            $storeId, $websiteId);
    }
    ...
    {
        return $this->getConfigValue(self::XML_PATH_CONFIG_LICENSE, false,
            $storeId, $websiteId);
    }
    ...
    {
        return $this->getConfigValue(self::XML_PATH_CONFIG_SECRET, false,
            $storeId, $websiteId);
    }
    ...
    {
        return $this->getConfigValue(self::XML_PATH_CONFIG_LOCALE, false,
            $storeId, $websiteId);
    }
    ...
    {
        return $this->getConfigValue(self::XML_PATH_CONFIG_DRAFT_UPDATE, false,
            $storeId, $websiteId);
    }
    ...
    public function getOrderDraftUpdateOrderId(
        ...
        return $this->getConfigValue(self::XML_PATH_CONFIG_DRAFT_UPDATE_ORDER_ID,
            false, $storeId, $websiteId);
    }
    ...
    {
        return explode(',',
            $this->getConfigValue(self::XML_PATH_CONFIG_STATUS, false, $storeId,
                $websiteId) ?? '');
    }
    ...
    public function getRedirectProductOnCancel(
        ...
        return $this->getConfigValue(self::XML_PATH_CONFIG_REDIRECT_ON_CANCEL,
                false, $storeId, $websiteId) == '1';
    }
    ...
    {
        return $this->getConfigValue(self::XML_PATH_CONFIG_REDIRECT, false,
            $storeId, $websiteId);
    }
    ...
    {
        return $this->getConfigValue(self::XML_PATH_CONFIG_REDIRECT_URL, false,
            $storeId, $websiteId);
    }
    ...
    public function getOpenEditorPreviewText(
        ...
        return $this->getConfigValue(self::XML_PATH_CONFIG_OPEN_EDITOR_PREVIEW_TEXT,
            false, $storeId, $websiteId);
    }
    ...
    {
        return intval($this->getConfigValue(self::XML_PATH_CONFIG_SKIP_CONFIG,
            false, $storeId, $websiteId));
    }
    ...
    {
        return $this->getConfigValue(self::XML_PATH_CONFIG_WISHLIST_HINT, false,
            $storeId, $websiteId);
    }
    ...
    {
        return $this->getConfigValue(self::XML_PATH_CONFIG_IMAGE_PREVIEW, true,
            $storeId, $websiteId);
    }
    ...
    {
        return (int)$this->getConfigValue(self::XML_PATH_CONFIG_IMAGE_PREVIEW_WIDTH,
            false, $storeId, $websiteId);
    }
    ...
    {
        return (int)$this->getConfigValue(self::XML_PATH_CONFIG_IMAGE_PREVIEW_HEIGHT,
            false, $storeId, $websiteId);
    }
    ...
    {
        return (int)$this->getConfigValue(self::XML_PATH_CONFIG_IMAGE_THUMB_WIDTH,
            false, $storeId, $websiteId);
    }
    ...
    public function getImageThumbnailHeight(
        ...
        return (int)$this->getConfigValue(self::XML_PATH_CONFIG_IMAGE_THUMB_HEIGHT,
            false, $storeId, $websiteId);
    }
    ...
    {
        return $this->getConfigValue(self::XML_PATH_CONFIG_EDIT_TEXT, false,
            $storeId, $websiteId);
    }
    ...
    public function getExpireDate(
        ...
        $days = $this->getConfigValue(self::XML_PATH_CONFIG_EXPIRE_DATE, false,
            $storeId, $websiteId);
        ...
        try {
            ...
            $expireDateTimeImmutable
                              = $dateTimeImmutable->add($dateTimeInterval);
        } catch (\Exception $e) {
    ...
    public function getExpireDateTimeStamp(
        ...
        return (new \DateTime())->add(\DateInterval::createFromDateString('+'
            .$days.' days'))->getTimestamp();
    }
    ...
    {
        return $this->getConfigValue(self::XML_PATH_CONFIG_BUTTON_TEXT, false,
            $storeId, $websiteId);
    }
    ...
    {
        return $this->getConfigValue(self::XML_PATH_CONFIG_UPLOAD_TEMPLATE_ID,
            false, $storeId, $websiteId);
    }
    ...
    {
        return $this->getConfigValue(self::XML_PATH_CONFIG_BUTTON_CSS, false,
            $storeId, $websiteId);
    }
    ...
    {
        return $this->getConfigValue(self::XML_PATH_CONFIG_FORMAT_CHANGE_NOTICE,
            true, $storeId, $websiteId);
    }
    ...
    {
        $text = $this->getConfigValue(self::XML_PATH_CONFIG_CLOSE_NOTICE_TEXT,
            false, $storeId, $websiteId);
    ...
    {
        return $this->getConfigValue(self::XML_PATH_CONFIG_FORMAT_NOTICE_TEXT,
            false, $storeId, $websiteId);
    }
    ...
    public function getFormatQueryParameter(
        ...
        return $this->getConfigValue(self::XML_PATH_CONFIG_FORMAT_QUERY_PARAMETER,
            false, $storeId, $websiteId);
    }
    ...
    public function isFormatAttributeEnabled(
        ...
        return $this->getConfigValue(self::XML_PATH_CONFIG_FORMAT_ATTRIBUTE_ENABLED,
            true, $storeId, $websiteId);
    }
    ...
    {
        return $this->getConfigValue(self::XML_PATH_CONFIG_FORMAT_ATTRIBUTE_NAME,
            false, $storeId, $websiteId);
    }
    ...
    public function getFormatAttributeValues(
        ...
        $value
            = $this->getConfigValue(self::XML_PATH_CONFIG_FORMAT_ATTRIBUTE_VALUES,
            false, $storeId, $websiteId);
    ...
    {
        return $this->getConfigValue(self::XML_PATH_CONFIG_FORMAT_OPTION_ENABLED,
            true, $storeId, $websiteId);
    }
    ...
    {
        return $this->getConfigValue(self::XML_PATH_CONFIG_FORMAT_OPTION_NAME,
            false, $storeId, $websiteId);
    }
    ...
    {
        $value
            = $this->getConfigValue(self::XML_PATH_CONFIG_FORMAT_OPTION_VALUES,
            false, $storeId, $websiteId);
    ...
    {
        return $this->getConfigValue(self::XML_PATH_CONFIG_COLOR_QUERY_PARAMETER,
            false, $storeId, $websiteId);
    }
    ...
    public function isColorAttributeEnabled(
        ...
        return $this->getConfigValue(self::XML_PATH_CONFIG_COLOR_ATTRIBUTE_ENABLED,
            true, $storeId, $websiteId);
    }
    ...
    {
        return $this->getConfigValue(self::XML_PATH_CONFIG_COLOR_ATTRIBUTE_NAME,
            false, $storeId, $websiteId);
    }
    ...
    public function getColorAttributeValues(
        ...
        $value
            = $this->getConfigValue(self::XML_PATH_CONFIG_COLOR_ATTRIBUTE_VALUES,
            false, $storeId, $websiteId);
    ...
    {
        return $this->getConfigValue(self::XML_PATH_CONFIG_COLOR_OPTION_ENABLED,
            true, $storeId, $websiteId);
    }
    ...
    {
        return $this->getConfigValue(self::XML_PATH_CONFIG_COLOR_OPTION_NAME,
            false, $storeId, $websiteId);
    }
    ...
    {
        $value
            = $this->getConfigValue(self::XML_PATH_CONFIG_COLOR_OPTION_VALUES,
            false, $storeId, $websiteId);
    ...
    {
        $decryptedKey = null;
        $encryptedKey = $this->getConfigValue(self::XML_PATH_V2_API_KEY, false,
            $storeId, $websiteId);
    ...
    {
        return $this->getConfigValue(self::XML_PATH_V2_IDENTIFIER, false,
            $storeId, $websiteId);
    }
    ...
    {
        $clientUrl       = $this->getConfigValue(self::XML_PATH_V2_URL, false,
            $storeId, $websiteId);
        $resultClientUrl = '';
        if (!empty($clientUrl)) {
    ...
    {
        return $this->getConfigValue(self::XML_PATH_CONFIG_SHOW_DELETE_BUTTON,
            true, $storeId, $websiteId);
    }
    ...
    {
        return $this->getConfigValue(self::XML_PATH_CONFIG_DELETE_CONFIRM_TEXT,
            false, $storeId, $websiteId);
    }
    ...
    {
        if ($productType === $this::CONFIGURABLE_TYPE_CODE
            && !$this->filterForConfigurableProduct()
        ) {
            $result = true;
        } else {
            $result = false;
     ...
     * @return bool
     */
    public function filterForConfigurableProduct(
        $storeId = false,
        $websiteId = false
    ) {
        return true;
...
//        return $this->getConfigValue(self::XML_PATH_CONFIG_FILTER_FOR_CONFIGURABLE_PRODUCT, true, $storeId, $websiteId);
    ...
    public function setDraftsOnItemType($item, $draftIds): Item
    {
        if ($this->useChildProduct($item->getProductType())) {
            ...
            if (!empty($childItems)) {
                $firstChildItem = $childItems[0];
                $firstChildItem->setData(InstallSchema::COLUMN_NAME_DRAFTID,
                    $draftIds);
    ...
    {
        return $this->getConfigValue(self::XML_PATH_CONFIG_TRANSFER_USER_DATA,
            true, $storeId, $websiteId);
    }
    ...
    {
        return $this->getConfigValue(self::XML_PATH_INVENTORY_MANAGE_STOCK_CONFIG_ENABLED,
            false);
    }
}
