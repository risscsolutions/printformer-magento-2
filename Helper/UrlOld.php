...
class UrlOld extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    {
        return $this->printformerUrl."/".self::URI_CUSTOMER_PDF.$draftId
            ."/low-res"; // print; low-res
    }
     ...
     * @return string
     */
    public function getAdminEditorUrl(
        $draftId,
        array $params = null,
        $referrer = null
    ) {
    ...
    public function getDraftEditorUrl($draftId)
    {
        ...
        return implode('/', $urlParts).(!empty($authParams) ? '?'.implode('&',
                    $authParams) : '');
    }
    ...
    public function getDraftOrderedUrl(array $draftIds, $quoteId)
    {
        ...
        return implode('/', $urlParts).'?cartdata='
    ...
    public function getRedirectUrl(
        ...
        return $this->url->getUrl($redirectParams['controller'],
